...
class PressureSensor(Node):
  ...
  def __init__(self):
    ...
    self.declare_parameter('/pressure_node/noise', 10.0, ParameterDescriptor(type=ParameterType.PARAMETER_DOUBLE))
    self.std_dev = self.get_parameter('/pressure_node/noise').get_parameter_value().double_value
