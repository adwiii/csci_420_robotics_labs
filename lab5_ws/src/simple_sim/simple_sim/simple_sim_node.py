...
class SimpleSim(Node):
    ...
    def mainloop(self):
        ...
        self.vel.x += thrust_perc * (self.cmd_vel.x - self.vel.x) + np.random.normal(scale=self.vel_noise)
        self.vel.y += thrust_perc * (self.cmd_vel.y - self.vel.y) + np.random.normal(scale=self.vel_noise)
        self.vel.z += thrust_perc * (self.cmd_vel.z - self.vel.z) + np.random.normal(scale=self.vel_noise)
